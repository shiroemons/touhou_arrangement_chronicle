...
func (r *AlbumCircleRepository) Add(ctx context.Context, circle *entity.AlbumCircle) (*entity.AlbumCircle, error) {
...
func (r *AlbumCircleRepository) Remove(ctx context.Context, circle *entity.AlbumCircle) error {
	tx, ok := ctx.Value(TxCtxKey).(*bun.Tx)
	if ok {

...
func (r *SongComposerRepository) Add(ctx context.Context, artist *entity.SongComposer) (*entity.SongComposer, error) {
...
func (r *SongComposerRepository) Remove(ctx context.Context, artist *entity.SongComposer) error {
	tx, ok := ctx.Value(TxCtxKey).(*bun.Tx)
	if ok {

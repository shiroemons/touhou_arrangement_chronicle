...
func (r *SongVocalistRepository) Add(ctx context.Context, artist *entity.SongVocalist) (*entity.SongVocalist, error) {
...
func (r *SongVocalistRepository) Remove(ctx context.Context, artist *entity.SongVocalist) error {
	tx, ok := ctx.Value(TxCtxKey).(*bun.Tx)
	if ok {

...
| albums_tags_pkey | PRIMARY KEY | PRIMARY KEY (album_id, tag_id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| albums_tags_pkey | CREATE UNIQUE INDEX albums_tags_pkey ON public.albums_tags USING btree (album_id, tag_id) |
